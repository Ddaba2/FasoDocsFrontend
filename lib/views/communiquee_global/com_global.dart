...
// 1. AppBar personnalisée
      ...
      appBar: _buildCustomAppBar(
        ...
        context, // Passer le contexte pour accéder au thème
...
// 5. Bouton flottant d'assistance/chatbot

      floatingActionButton: FloatingActionButton(

        onPressed: () {

// Action pour l'assistance ou le chatbot

        },

// FOND: Utilise la couleur de carte pour contraster avec le fond

        backgroundColor: cardColor,

        foregroundColor: iconColor, // ICÔNE: Couleur dynamique

        shape: CircleBorder(

            side: BorderSide(color: iconColor.withOpacity(0.5), width: 1.0) // BORDURE: Couleur dynamique
